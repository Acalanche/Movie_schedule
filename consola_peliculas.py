...
def ejecutar_encontrar_pelicula_mas_larga(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    """
    res = mod.encontrar_pelicula_mas_larga(p1,p2,p3,p4,p5)
    print(res)
...
def ejecutar_consultar_duracion_promedio_peliculas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    res = mod.duracion_promedio_peliculas(p1,p2,p3,p4,p5)
    print("duracion promedio de peliculas en horas y minutos "+res)
...
def ejecutar_encontrar_estrenos(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    res = mod.encontrar_estrenos(p1,p2,p3,p4,p5,anio)
    print(res)
...
def ejecutar_cuantas_peliculas_18_mas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    res = mod.cuantas_peliculas_18_mas(p1,p2,p3,p4,p5)
    print("El número de peliculas 18+ es: "+str(res))
...
def ejecutar_reagendar_pelicula(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    respuesta = input("Desea establecer un control de horario:(y) o (n)")
...
def ejecutar_decidir_invitar(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    if pelicula is None:
        return print("No hay ninguna pelicula con este nombre")
    edad = int ( input("Ingrese edad del invitado: ") )
    autorizacion = False
    if edad < 18:
        autorizacion = input("Tiene autorización para ver la pelicula?(y),(n):")
        if autorizacion == "s":
            autorizacion = True
        else:
            autorizacion = False
    res = mod.decidir_invitar(pelicula,edad,autorizacion)
